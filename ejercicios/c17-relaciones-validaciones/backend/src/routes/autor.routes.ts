...
import { autorCreateSchema } from "../validations/autor.validation";
...
router.put("/:id", validateParams(idParamSchema), validate(autorCreateSchema), autorController.update);
